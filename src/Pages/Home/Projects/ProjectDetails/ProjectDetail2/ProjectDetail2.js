...
const ProjectDetail2 = () => {
    return (
        <div className='ml-40'>
            <h3 className='text-4xl font-semibold text-center'>Warehouse Management</h3>
            ...
            <div>
                <a href="https://project-warehouse-manage-52c58.web.app/">Live-site</a>
                <a href="">Client-side code</a>
                <a href="">Server-side code</a>
            </div>
            <div className='text-start ml-40'>
                <p>On the home page, there are four sections. Banner, books section, and two extra sections.</p>
